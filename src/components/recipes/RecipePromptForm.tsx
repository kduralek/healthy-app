...
export function RecipePromptForm({ onSubmit, isLoading, error }: RecipePromptFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" data-testid="recipe-prompt-form">
      ...
      <div className="flex items-center justify-end gap-4">
        ...
        <Button type="submit" disabled={!state.isValid || isLoading} data-testid="generate-recipe-button">
          Generuj przepis
        </Button>
      </div>
    </form>
